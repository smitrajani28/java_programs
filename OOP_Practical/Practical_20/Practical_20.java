...
public class Practical_20 extends Application {
    protected Text text = new Text(50, 50, "•\tWrite a GUI program that use button to move the message to the left and right and use the radio button to change the color for the message displayed");
